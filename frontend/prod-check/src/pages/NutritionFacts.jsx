...
export default function NutritionFacts() {
  ...
  // ✅ 테스트용 user 데이터 (나중에 로그인 유저 정보로 대체)
  const user = {
    name: "홍길동",
    allergies: "밀,땅콩,카페인",
  };
    ...
    setRecommendedProducts([
      {
        id: 101,
        name: "진짬뽕 컵라면 115g",
        image: "/images/jjambbong.png",
      },
      {
        id: 102,
        name: "열라면 큰사발 110g",
        image: "/images/yeolramyun.png",
      },
      {
        id: 103,
        name: "비빔면 130g",
        image: "/images/bibimmyun.png",
      },
    ]);
  }, [id]);
  ...
  const resultStatus = "suitable"; // 테스트용
  ...
  try {
    ...
    const matchedPotentialAllergies = userAllergiesArray.filter((a) =>
